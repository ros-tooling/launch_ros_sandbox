...
"""
Minimal example for using SandboxedNodeContainer with DockerPolicy with limited memory.
...
- Send SIGINT to the launch process. (ctrl+c or kill -SIGINT)

How to run listener inside the Docker container
- docker exec -it sandboxed-listener-node ros2 run demo_nodes_cpp listener
"""
...
def generate_launch_description() -> LaunchDescription:
    ...
    he Docker policy uses a Docker image of ROS2 Dashing (Desktop) from 'osrf/ros'.
    ...
    The container will be restricted to 128MB of RAM.
    """
